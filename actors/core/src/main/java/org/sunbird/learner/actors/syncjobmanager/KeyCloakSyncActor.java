...
public class KeyCloakSyncActor extends UntypedAbstractActor {
	...
	private void syncData(Request message) {
		...
		if (null != userIds && !userIds.isEmpty()) {
			ProjectLogger
					.log("fetching data for user for these ids " + Arrays.toString(userIds.toArray()) + " started");
			...
			ProjectLogger.log("fetching data for user for these ids " + Arrays.toString(userIds.toArray()) + " done");
		}
		...
		ProjectLogger.log("total time taken to sync db data for user to keycloak " + elapsedTime + " ms.");
