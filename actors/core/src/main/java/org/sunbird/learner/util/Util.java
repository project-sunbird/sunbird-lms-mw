...
public final class Util {
    ...
    private static void initializeAuditLogUrl() {
        ...
        auditLogUrlMap.put(ActorOperations.CREATE_USER.getValue(),
                new AuditOperation(JsonKey.USER, JsonKey.CREATE));
        auditLogUrlMap.put(ActorOperations.UPDATE_USER.getValue(),
                new AuditOperation(JsonKey.USER, JsonKey.UPDATE));
        ...
        auditLogUrlMap.put(ActorOperations.REJECT_USER_ORGANISATION.getValue(),
                new AuditOperation(JsonKey.ORGANISATION, JsonKey.UPDATE));
        auditLogUrlMap.put(ActorOperations.BLOCK_USER.getValue(),
                new AuditOperation(JsonKey.USER, JsonKey.UPDATE));
        auditLogUrlMap.put(ActorOperations.UNBLOCK_USER.getValue(),
                new AuditOperation(JsonKey.USER, JsonKey.UPDATE));
        auditLogUrlMap.put(ActorOperations.ASSIGN_ROLES.getValue(),
                new AuditOperation(JsonKey.USER, JsonKey.UPDATE));
        auditLogUrlMap.put(ActorOperations.CREATE_BATCH.getValue(),
                new AuditOperation(JsonKey.BATCH, JsonKey.CREATE));
        auditLogUrlMap.put(ActorOperations.UPDATE_BATCH.getValue(),
                new AuditOperation(JsonKey.BATCH, JsonKey.UPDATE));
        auditLogUrlMap.put(ActorOperations.REMOVE_BATCH.getValue(),
                new AuditOperation(JsonKey.BATCH, JsonKey.UPDATE));
        ...
        auditLogUrlMap.put(ActorOperations.REMOVE_USER_FROM_BATCH.getValue(),
                new AuditOperation(JsonKey.BATCH, JsonKey.UPDATE));
        auditLogUrlMap.put(ActorOperations.CREATE_NOTE.getValue(),
                new AuditOperation(JsonKey.USER, JsonKey.CREATE));
        auditLogUrlMap.put(ActorOperations.UPDATE_NOTE.getValue(),
                new AuditOperation(JsonKey.USER, JsonKey.UPDATE));
        auditLogUrlMap.put(ActorOperations.DELETE_NOTE.getValue(),
                new AuditOperation(JsonKey.USER, JsonKey.UPDATE));
    ...
    private static void initializeDBProperty() {
        ...
        dbInfoMap.put(JsonKey.LEARNER_CONTENT_DB,
                getDbInfoObject(KEY_SPACE_NAME, "content_consumption"));
        dbInfoMap.put(JsonKey.COURSE_MANAGEMENT_DB,
                getDbInfoObject(KEY_SPACE_NAME, "course_management"));
        ...
        dbInfoMap.put(JsonKey.ASSESSMENT_EVAL_DB,
                getDbInfoObject(KEY_SPACE_NAME, "assessment_eval"));
        dbInfoMap.put(JsonKey.ASSESSMENT_ITEM_DB,
                getDbInfoObject(KEY_SPACE_NAME, "assessment_item"));
        ...
        dbInfoMap.put(JsonKey.USR_EXT_ID_DB,
                getDbInfoObject(KEY_SPACE_NAME, "user_external_identity"));
        ...
        dbInfoMap.put(JsonKey.USER_ACTION_ROLE,
                getDbInfoObject(KEY_SPACE_NAME, "user_action_role"));
        ...
        dbInfoMap.put(JsonKey.COURSE_PUBLISHED_STATUS,
                getDbInfoObject(KEY_SPACE_NAME, "course_publish_status"));
        dbInfoMap.put(JsonKey.REPORT_TRACKING_DB,
                getDbInfoObject(KEY_SPACE_NAME, "report_tracking"));
        ...
        dbInfoMap.put(JsonKey.TENANT_PREFERENCE_DB,
                getDbInfoObject(KEY_SPACE_NAME, "tenant_preference"));
        ...
        dbInfoMap.put(JsonKey.SYSTEM_SETTINGS_DB,
                getDbInfoObject(KEY_SPACE_NAME, "system_settings"));
     ...
     * organization from current state to next state if possible to move then return true else
     * false.
     *
    ...
    /**
     * This method will check the cassandra data base connection. first it will try to established
     * the data base connection from provided environment variable , if environment variable values
            ...
            for (int i = 0; i < ipList.length; i++) {
                ...
                try {
                    ...
                    boolean result = cassandraConnectionManager.createConnection(ip, port, userName,
                            password, keySpace);
                    if (result) {
                        ProjectLogger.log("CONNECTION CREATED SUCCESSFULLY FOR IP: " + ip
                                + " : KEYSPACE :" + keySpace, LoggerEnum.INFO.name());
                    } else {
                        ProjectLogger.log("CONNECTION CREATION FAILED FOR IP: " + ip
                                + " : KEYSPACE :" + keySpace);
                    }
    ...
    public static class DbInfo {
         ...
         * @param password
         */
        DbInfo(String keySpace, String tableName, String userName, String password, String ip,
                String port) {
    ...
    public static SearchDTO createSearchDto(Map<String, Object> searchQueryMap) {
        ...
        if (searchQueryMap.containsKey(JsonKey.FILTERS)) {
            search.getAdditionalProperties().put(JsonKey.FILTERS,
                    searchQueryMap.get(JsonKey.FILTERS));
        }
        if (searchQueryMap.containsKey(JsonKey.EXISTS)) {
            search.getAdditionalProperties().put(JsonKey.EXISTS,
                    searchQueryMap.get(JsonKey.EXISTS));
        }
        if (searchQueryMap.containsKey(JsonKey.NOT_EXISTS)) {
            search.getAdditionalProperties().put(JsonKey.NOT_EXISTS,
                    searchQueryMap.get(JsonKey.NOT_EXISTS));
        }
        if (searchQueryMap.containsKey(JsonKey.SORT_BY)) {
            search.getSortBy().putAll(
                    (Map<? extends String, ? extends String>) searchQueryMap.get(JsonKey.SORT_BY));
        }
    ...
    public static void getContentData(Map<String, Object> section) {
        ...
        try {
            ...
            response = HttpUtil.sendPostRequest(
                    baseSearchUrl + PropertiesCache.getInstance()
                            .getProperty(JsonKey.EKSTEP_CONTENT_SEARCH_URL),
            ...
            section.put(JsonKey.CONTENTS,
                    mapper.readValue(contentArray.toString(), Object[].class));
    ...
    private static Map<String, Object> elasticSearchComplexSearch(Map<String, Object> filters,
    ...
    public static boolean registerChannel(Map<String, Object> req) {
        ...
        try {
            ...
            regStatus = HttpUtil.sendPostRequest(
                    ...
                    reqString, headerMap);
            ProjectLogger.log("end call for channel registration for hashTag id =="
                    + req.get(JsonKey.HASHTAGID));
        } catch (Exception e) {
    ...
    public static boolean updateChannel(Map<String, Object> req) {
        ...
        try {
            ...
            regStatus = HttpUtil.sendPatchRequest((ekStepBaseUrl + PropertiesCache.getInstance()
                    .getProperty(JsonKey.EKSTEP_CHANNEL_UPDATE_API_URL)) + "/"
                    + req.get(JsonKey.HASHTAGID), reqString, headerMap);
            ProjectLogger.log("end call for channel registration for hashTag id =="
                    + req.get(JsonKey.HASHTAGID));
        } catch (Exception e) {
            ProjectLogger.log("Exception occurred while registarting channel in ekstep.", e);
    ...
    public static void initializeContext(Request actorMessage, String env) {
        ...
        if (actorMessage.getContext().get(JsonKey.TELEMETRY_CONTEXT) != null) {
            ...
            requestContext.put(JsonKey.ACTOR_TYPE,
                    actorMessage.getContext().get(JsonKey.ACTOR_TYPE));
    ...
    private static Map<String, Object> getOrgDetails(String identifier) {
        ...
        Response response = cassandraOperation.getRecordById(orgDbInfo.getKeySpace(),
                orgDbInfo.getTableName(), identifier);
