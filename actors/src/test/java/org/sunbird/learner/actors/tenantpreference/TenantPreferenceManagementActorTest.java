...
public class TenantPreferenceManagementActorTest {
  ...
  public static void destroy() {
    ...
    ElasticSearchUtil.removeData(EsIndex.sunbird.getIndexName(), EsType.user.getTypeName(),
        USER_ID);
    ...
    for (Map<String, Object> map : list) {
      ...
      cassandraOperation.deleteRecord(tenantPreferenceDbInfo.getKeySpace(),
          tenantPreferenceDbInfo.getTableName(), id);
    }
