...
@ActorConfig(tasks = {"createOrg", "approveOrg", "updateOrg", "updateOrgStatus", "getOrgDetails",
        "addMemberOrganisation", "removeMemberOrganisation", "getOrgTypeList", "createOrgType",
        "updateOrgType", "approveUserOrganisation", "joinUserOrganisation",
        "rejectUserOrganisation", "downlaodOrg"}, asyncTasks = {})
