 ...
 */
@ActorConfig(
  tasks = {"createCourse", "updateCourse", "publishCourse", "deleteCourse"},
  asyncTasks = {}
)
    ...
    try {
      ...
      resposne =
          HttpUtil.sendPostRequest(
              ...
              coursePublishedBody.replace("userId", updatedBy),
              headers);
    } catch (Exception e) {
  ...
  private void updateCourse(Request actorMessage) {
    ...
    Response result =
        cassandraOperation.getRecordById(
            dbInfo.getKeySpace(), dbInfo.getTableName(), (String) req.get(JsonKey.COURSE_ID));
