...
public class UserProfileActor extends UserBaseActor {
  ...
  public void onReceive(Request request) throws Throwable {
    ...
    if (operation.equalsIgnoreCase(ActorOperations.GET_MEDIA_TYPES.getValue())) {
      getMediaTypes();
  ...
  private void updaeProfileVisibility(String userId,
      List<String> privateList, List<String> publicList, Map<String, Object> esResult) {
  ...
  private void updateCassandraWithPrivateFiled(String userId, Map<String, String> privateFieldMap) {
    ...
    Response response =
        getUserDao().updateUser(UserDaoFactory.toUser(reqMap));
