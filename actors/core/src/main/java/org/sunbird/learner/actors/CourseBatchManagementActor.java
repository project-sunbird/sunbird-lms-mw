...
@ActorConfig(tasks = {"createBatch", "updateBatch", "addUserBatch", "removeUserFromBatch",
        "getBatch", "getCourseBatchDetail"}, asyncTasks = {})
public class CourseBatchManagementActor extends BaseActor {
    ...
    private void getCourseBatchDetail(Request actorMessage) {
        ...
        Response result = cassandraOperation.getRecordById(dbInfo.getKeySpace(),
            ...
            if (!(participants.containsKey(userId))) {
                ...
                participants.put(userId,
                        addUserCourses(batchId, (String) courseBatchObject.get(JsonKey.COURSE_ID),
                                userId, (Map<String, String>) (courseBatchObject
                ...
                targetObject = TelemetryUtil.generateTargetObject(userId, JsonKey.USER,
                        JsonKey.UPDATE, null);
    ...
    private String getRootOrg(String batchCreator) {
        Map<String, Object> userInfo = ElasticSearchUtil.getDataByIdentifier(
        ...
        if (null != resList && !resList.isEmpty()) {
            ...
            if (null != req.get(JsonKey.START_DATE) && null != req.get(JsonKey.END_DATE)) {
                ...
                try {
                    ...
                    ProjectLogger.log(
                            "Exception occured while parsing date in CourseBatchManagementActor ",
                            e);
                }
            ...
            targetObject = TelemetryUtil.generateTargetObject((String) req.get(JsonKey.ID),
                    JsonKey.BATCH, JsonKey.UPDATE, null);
            TelemetryUtil.telemetryProcessingCall(req, targetObject, correlatedObject);
