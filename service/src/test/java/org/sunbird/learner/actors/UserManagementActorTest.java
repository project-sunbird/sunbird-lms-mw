...
public class UserManagementActorTest {
  ...
  private static final Props orgProps = Props.create(OrganisationManagementActor.class);
  private static final Props emailServiceProps = Props.create(EmailServiceActor.class);
  private static final Props badgeProps = Props.create(HealthActor.class);
  ...
  public void testCgetUserAddressInfo() {
    ...
    Response response =
        operation.getRecordsByProperty(
            addressDB.getKeySpace(), addressDB.getTableName(), JsonKey.USER_ID, encUserId);
  ...
  public void testDUpdatedUserAddressInfo() {
    ...
    String addrLine =
        (String)
            ((Map<String, Object>)
                    ((((List<Map<String, Object>>) result.get(JsonKey.RESPONSE)).get(0))))
  ...
  public void testEUpdatedUserEducationInfo() {
    Response response =
        operation.getRecordsByProperty(
            eduDB.getKeySpace(), eduDB.getTableName(), JsonKey.USER_ID, userId);
    Map<String, Object> result = (Map<String, Object>) (response.getResult());
    String name =
        (String)
            ((Map<String, Object>)
  ...
  public void testFUpdatedUserJobProfileInfo() {
    Response response =
        operation.getRecordsByProperty(
            jobDB.getKeySpace(), jobDB.getTableName(), JsonKey.USER_ID, userId);
    Map<String, Object> result = (Map<String, Object>) (response.getResult());
    String jobName =
        (String)
            ((Map<String, Object>)
                    ((((List<Map<String, Object>>) result.get(JsonKey.RESPONSE)).get(0))))
                .get(JsonKey.JOB_NAME);
  ...
  public void testGGetUserInfo() {
    ...
    addressId =
        (String)
            (((List<Map<String, Object>>) response.get(JsonKey.ADDRESS)).get(0)).get(JsonKey.ID);
    jobId =
        (String)
            (((List<Map<String, Object>>) response.get(JsonKey.JOB_PROFILE)).get(0))
                .get(JsonKey.ID);
    eduId =
        (String)
            (((List<Map<String, Object>>) response.get(JsonKey.EDUCATION)).get(0)).get(JsonKey.ID);
  }
  ...
  public void testJGetUserInfoByLoginId() {
    ...
    assertEquals(
        userResponse.getResponseCode().getResponseCode(), ResponseCode.OK.getResponseCode());
  }
  ...
  public void testJUserOrgInfo() {
    ...
    assertEquals(
        "DUMMY_ORG",
        (String)
            ((Map<String, Object>) response.get(JsonKey.REGISTERED_ORG))
  ...
  public void z18TestJoinUserOrganisation2() {
    ...
    Response response = probe.expectMsgClass(duration("200 second"), Response.class);
    assertEquals(
        ((String) response.getResult().get(JsonKey.RESPONSE)),
  ...
  public void z22TestgetUserBadge() {
    ...
    if (((String) badge.get(JsonKey.BADGE_TYPE_ID)).equalsIgnoreCase("0123206539020943360")) {
      cassandraOperation.deleteRecord(
          userBadgesDbInfo.getKeySpace(),
          userBadgesDbInfo.getTableName(),
  ...
  public static void deleteUser() {
    ...
    operation.deleteRecord(
        userManagementDB.getKeySpace(), userManagementDB.getTableName(), userId2);
    ...
    ElasticSearchUtil.removeData(
        ProjectUtil.EsIndex.sunbird.getIndexName(), ProjectUtil.EsType.user.getTypeName(), userId2);
    ...
    try {
      ...
      Response response =
          operation.getRecordsByProperty(
              usrExtIdDb.getKeySpace(), usrExtIdDb.getTableName(), JsonKey.USER_ID, userId);
      List<Map<String, Object>> mapList =
          (List<Map<String, Object>>) response.getResult().get(JsonKey.RESPONSE);
      for (Map<String, Object> map : mapList) {
        operation.deleteRecord(
            usrExtIdDb.getKeySpace(), usrExtIdDb.getTableName(), (String) map.get(JsonKey.ID));
      }

      response =
          operation.getRecordsByProperty(
              usrExtIdDb.getKeySpace(), usrExtIdDb.getTableName(), JsonKey.USER_ID, userIdnew);
      ...
      response =
          operation.getRecordsByProperty(
              usrExtIdDb.getKeySpace(), usrExtIdDb.getTableName(), JsonKey.USER_ID, userId2);
      mapList = (List<Map<String, Object>>) response.getResult().get(JsonKey.RESPONSE);
      for (Map<String, Object> map : mapList) {
        operation.deleteRecord(
            usrExtIdDb.getKeySpace(), usrExtIdDb.getTableName(), (String) map.get(JsonKey.ID));
    ...
    operation.deleteRecord(
        userManagementDB.getKeySpace(), userManagementDB.getTableName(), userIdnew);
    ...
    try {
      ...
      Response response =
          operation.getRecordsByProperties(
              userOrgDB.getKeySpace(), userOrgDB.getTableName(), userOrgMap);
      List<Map<String, Object>> mapList =
          (List<Map<String, Object>>) response.getResult().get(JsonKey.RESPONSE);
      for (Map<String, Object> map : mapList) {
        operation.deleteRecord(
            userOrgDB.getKeySpace(), userOrgDB.getTableName(), (String) map.get(JsonKey.ID));
      }
    } catch (Exception ex) {
