...
public class PageManagementActorTest {
	...
	public static void deletePageAndSection() {
		...
		if (pageIdWithOrg != null) {
			operation.deleteRecord(pageMgmntDbInfo.getKeySpace(), pageMgmntDbInfo.getTableName(), pageIdWithOrg);
		}
		// assertEquals("SUCCESS", response1.get("response"));
		if (pageIdWithOrg2 != null) {
			operation.deleteRecord(pageMgmntDbInfo.getKeySpace(), pageMgmntDbInfo.getTableName(), pageIdWithOrg2);
		}
		// assertEquals("SUCCESS", response11.get("response"));
		if (sectionId != null) {
			operation.deleteRecord(pageSectionDbInfo.getKeySpace(), pageSectionDbInfo.getTableName(), sectionId);
		}
		// assertEquals("SUCCESS", response2.get("response"));
		if (sectionId2 != null) {
			operation.deleteRecord(pageSectionDbInfo.getKeySpace(), pageSectionDbInfo.getTableName(), sectionId2);
		}
		...
		result = operation.getRecordsByProperties(pageMgmntDbInfo.getKeySpace(), pageMgmntDbInfo.getTableName(), dbMap);
