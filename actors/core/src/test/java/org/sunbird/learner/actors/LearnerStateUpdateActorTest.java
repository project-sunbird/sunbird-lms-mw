...
public class LearnerStateUpdateActorTest {
	...
	private static void insertCourse() {
		...
		courseMap.put(JsonKey.ID, OneWayHashing.encryptVal(
	...
	public void addContentTest() throws Throwable {
		...
		Thread.sleep(3000);
		Response dbbRes = cassandraOperation.getRecordsByProperty(contentdbInfo.getKeySpace(),
				contentdbInfo.getTableName(), JsonKey.CONTENT_ID, contentId);
