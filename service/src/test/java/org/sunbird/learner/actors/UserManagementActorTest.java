...
public class UserManagementActorTest {
	...
	public void testACreateUser3() {
		...
		subject.tell(reqObj, probe.getRef());
		ProjectCommonException exc = probe.expectMsgClass(duration("200 second"), ProjectCommonException.class);
		assertTrue(null != exc);
	...
	public void testCgetUserAddressInfo() {
		...
		Response response = operation.getRecordsByProperty(addressDB.getKeySpace(), addressDB.getTableName(),
	...
	public void testDUpdatedUserAddressInfo() {
		...
		Response response = operation.getRecordsByProperty(addressDB.getKeySpace(), addressDB.getTableName(),
				JsonKey.USER_ID, encUserId);
		Map<String, Object> result = (Map<String, Object>) (response.getResult());
		String addrLine = (String) ((Map<String, Object>) ((((List<Map<String, Object>>) result.get(JsonKey.RESPONSE))
	...
	public void testEUpdatedUserEducationInfo() {
		Response response = operation.getRecordsByProperty(eduDB.getKeySpace(), eduDB.getTableName(), JsonKey.USER_ID,
				userId);
		Map<String, Object> result = (Map<String, Object>) (response.getResult());
		String name = (String) ((Map<String, Object>) ((((List<Map<String, Object>>) result.get(JsonKey.RESPONSE))
	...
	public void testFUpdatedUserJobProfileInfo() {
		Response response = operation.getRecordsByProperty(jobDB.getKeySpace(), jobDB.getTableName(), JsonKey.USER_ID,
				userId);
		Map<String, Object> result = (Map<String, Object>) (response.getResult());
		String jobName = (String) ((Map<String, Object>) ((((List<Map<String, Object>>) result.get(JsonKey.RESPONSE))
	...
	public void testJUserOrgInfo() {
		...
		Map<String, Object> result = (Map<String, Object>) (userResponse.getResult());
		Map<String, Object> response = (Map<String, Object>) result.get(JsonKey.RESPONSE);
		assertEquals("DUMMY_ORG",
				(String) ((Map<String, Object>) response.get(JsonKey.REGISTERED_ORG)).get(JsonKey.ORGANISATION_NAME));
	}
	...
	public void testKUserOrgTableInfo() {
		...
		Response response = operation.getRecordsByProperties(userOrgDB.getKeySpace(), userOrgDB.getTableName(), map);
		Map<String, Object> result = (Map<String, Object>) (response.getResult());
		List<String> roles = (List) ((Map<String, Object>) ((((List<Map<String, Object>>) result.get(JsonKey.RESPONSE))
				.get(0)))).get(JsonKey.ROLES);
		assertFalse(roles.contains(ProjectUtil.UserRole.CONTENT_CREATOR.getValue()));
		userOrgId = (String) ((Map<String, Object>) ((((List<Map<String, Object>>) result.get(JsonKey.RESPONSE))
	...
	public void z17TestAssignRolesWithoutOrgId() {
		...
		subject.tell(reqObj, probe.getRef());
		probe.expectMsgClass(duration("200 second"), Response.class);
		Map<String, Object> map = ElasticSearchUtil.getDataByIdentifier(ProjectUtil.EsIndex.sunbird.getIndexName(),
	...
	public void z22TestgetUserBadge() {
		...
		if (((String) badge.get(JsonKey.BADGE_TYPE_ID)).equalsIgnoreCase("0123206539020943360")) {
			cassandraOperation.deleteRecord(userBadgesDbInfo.getKeySpace(), userBadgesDbInfo.getTableName(),
					((String) badge.get(JsonKey.ID)));
		}
	...
	public static void deleteUser() {
		...
		ElasticSearchUtil.removeData(ProjectUtil.EsIndex.sunbird.getIndexName(), ProjectUtil.EsType.user.getTypeName(),
				userId);
		...
		try {
			...
			Response response = operation.getRecordsByProperty(usrExtIdDb.getKeySpace(), usrExtIdDb.getTableName(),
		...
		try {
			...
			Response response = operation.getRecordsByProperties(userOrgDB.getKeySpace(), userOrgDB.getTableName(),
					userOrgMap);
			List<Map<String, Object>> mapList = (List<Map<String, Object>>) response.getResult().get(JsonKey.RESPONSE);
			for (Map<String, Object> map : mapList) {
				operation.deleteRecord(userOrgDB.getKeySpace(), userOrgDB.getTableName(), (String) map.get(JsonKey.ID));
			}
		} catch (Exception ex) {
