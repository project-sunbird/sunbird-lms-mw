...
@PrepareForTest({ ServiceFactory.class, ElasticSearchUtil.class, CassandraOperationImpl.class, DataCacheHandler.class, org.sunbird.common.models.util.datasecurity.impl.ServiceFactory.class})
...
public class UserAssignRoleTest {
	...
	private static List<String> ALL_ROLES = Arrays.asList("CONTENT_CREATOR", "COURSE_MENTOR", "BOOK_CREATOR", "BOOK_REVIEWER", "OFFICIAL_TEXTBOOK_BADGE_ISSUER","TEACHER_BADGE_ISSUER","ANNOUNCEMENT_SENDER", "CONTENT_REVIEWER", "FLAG_REVIEWER", "PUBLIC");  
	...
	public static void setUp() throws Exception {
		...
		user_org.put(JsonKey.EXTERNAL_ID, externalId);
		user_org.put(JsonKey.PROVIDER, provider);
		user_org.put(JsonKey.ROLES, Arrays.asList("CONTENT_CREATOR", "COURSE_MENTOR", "BOOK_CREATOR", "BOOK_REVIEWER", "PUBLIC"));
