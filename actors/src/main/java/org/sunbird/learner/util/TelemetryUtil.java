...
public class TelemetryUtil {
  ...
  public static Map<String, Object> generateTargetObject(String id, String type,
      String currentState, String prevState) {
  ...
  public static void generateCorrelatedObject(String id, String type, String corelation,
      List<Map<String, Object>> correlationList) {
  ...
  public static void addTargetObjectRollUp(Map<String, String> rollUpMap,
