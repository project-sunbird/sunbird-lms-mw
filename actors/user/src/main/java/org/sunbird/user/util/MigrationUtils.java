...
public class MigrationUtils {
    ...
    public static ShadowUser getRecord(Map<String, Object> requestMap) {
        Map<String, Object> propertiesMap = new HashMap<>();
        propertiesMap.put(JsonKey.USER_EXT_ID, requestMap.get(JsonKey.USER_EXT_ID));
        propertiesMap.put(JsonKey.USER_ID, requestMap.get(JsonKey.USER_ID));
