...
public class BadgingUtil {
    ...
    public static String getBadgeClassUrl(String issuerSlug, String badgeSlug) {
        return String.format("%s/v1/issuer/issuers/%s/badges/%s", getBadgrBaseUrl(), issuerSlug,
                badgeSlug);
    }
    ...
    public static void prepareBadgeClassResponse(Map<String, Object> inputMap,
            BadgeClassExtension badgeClassExtension, Map<String, Object> outputMap)
            throws IOException {
        ...
        MapperUtil.put(inputMap, BadgingJsonKey.JSON_ISSUER, outputMap,
                BadgingJsonKey.ISSUER_ID_URL);
        ...
        MapperUtil.put(inputMap, BadgingJsonKey.RECIPIENT_COUNT, outputMap,
                JsonKey.RECIPIENT_COUNT);
    ...
    public static void prepareBadgeClassResponse(String inputJson,
            BadgeClassExtension badgeClassExtension, Map<String, Object> outputMap)
            throws IOException {
    ...
    private static String createUri(Map<String, Object> map, String uri, int placeholderCount) {
        if (placeholderCount == 0) {
            ...
            return MessageFormat.format(uri,
                    map.get(BadgingJsonKey.ISSUER_ID) != null ? map.get(BadgingJsonKey.ISSUER_ID)
                            : DEFAULT_ISSUER_ID,
                    map.get(BadgingJsonKey.BADGE_ID) != null ? map.get(BadgingJsonKey.BADGE_ID)
                            : DEFAULT_BADGE_ID,
    ...
    /**
     * This method will create url for badger server call. in badger url pattern is first
     * placeholder is issuerSlug, 2nd badgeclass slug and 3rd badgeassertion slug
     * 
     ...
     * @return Stirng url
     */
    public static String createBadgerUrl(Map<String, Object> map, String uri,
    ...
    public static void prepareBadgeIssuerResponse(Map<String, Object> inputMap,
            Map<String, Object> outputMap) throws IOException {
        MapperUtil.put(inputMap, BadgingJsonKey.CREATED_AT, outputMap, JsonKey.CREATED_DATE);
    ...
    public static Map<String, Object> createBadgeNotifierMap(Map<String, Object> reqMap) {
        ...
        request.getRequest().put(BadgingJsonKey.BADGE_CLASS_ID,
    ...
    /**
     * This method will take response data from badger server as input map and then prepare a new
     * map as outPut map by changing the key and some values.
     * 
    ...
    public static Map<String, Object> prepareAssertionResponse(Map<String, Object> inputMap,
        ...
        MapperUtil.put(inputMap, BadgingJsonKey.CREATED_AT, outPutMap, JsonKey.CREATED_DATE);
        MapperUtil.put(inputMap, BadgingJsonKey.JSON_ISSUED_ON, outPutMap,
                BadgingJsonKey.ASSERTION_DATE);
        ...
        if (outPutMap.containsKey(BadgingJsonKey.BADGE_ID_URL)) {
            outPutMap.put(BadgingJsonKey.BADGE_ID,
        ...
        MapperUtil.put(inputMap, BadgingJsonKey.JSON_RECIPIENT, outPutMap,
                BadgingJsonKey.RECIPIENT);
        MapperUtil.put(inputMap, BadgingJsonKey.RECIPIENT_IDENTIFIER, outPutMap,
                BadgingJsonKey.RECIPIENT_EMAIL);
        ...
        MapperUtil.put(inputMap, BadgingJsonKey.REVOCATION_REASON_BADGE, outPutMap,
    ...
    /**
     * Badger is having some issues , to get badge assertion data , badger required issuerId,
     * badgeId, assertionId but internally it's checking only assertionId other's values can be any
     * thing and it will provide the response. so to avoid this we have the check request issuerId,
     * badgeId need to be same as response data.
     * 
