...
public class NotesManagementActorTest {
	...
	/**
	 * Method to test create Note when data is valid. Expected to create note
	 * without exception
	 */
	...
	/**
	 * Method to test get Note when noteId is valid. Expected to get note details
	 * for the given noteId
	 */
	...
	/**
	 * Method to test update Note when data is valid. Expected to update note with
	 * the given data
	 */
	@SuppressWarnings("deprecation")
	@Test
	...
	/**
	 * Method to test search Note when data is valid. Expected to return note data
	...
	/**
	 * Method to test delete Note when data is valid. Expected to mark note as
	 * deleted and send success message
	 */
	@SuppressWarnings("deprecation")
	@Test
