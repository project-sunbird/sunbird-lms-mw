...
public class RequestRouterActor extends UntypedAbstractActor {
	...
	public RequestRouterActor() {
		courseEnrollmentActorRouter = getContext().actorOf(
				FromConfig.getInstance().props(Props.create(CourseEnrollmentActor.class)), COURSE_ENROLLMENT_ROUTER);
		learnerStateActorRouter = getContext()
		...
		pageManagementRouter = getContext().actorOf(
				FromConfig.getInstance().props(Props.create(PageManagementActor.class)), PAGE_MANAGEMENT_ROUTER);
		...
		courseSearchActorRouter = getContext().actorOf(
				FromConfig.getInstance().props(Props.create(CourseSearchActor.class)), COURSE_SEARCH_ACTOR_ROUTER);
		assessmentItemActor = getContext().actorOf(
				FromConfig.getInstance().props(Props.create(AssessmentItemActor.class)), ASSESSMENT_ITEM_ACTOR_ROUTER);
		recommendorActorRouter = getContext().actorOf(
				FromConfig.getInstance().props(Props.create(RecommendorActor.class)), RECOMMENDOR_ACTOR_ROUTER);
		searchHandlerActor = getContext().actorOf(
				FromConfig.getInstance().props(Props.create(SearchHandlerActor.class)), SEARCH_HANDLER_ACTOR_ROUTER);
		bulkUploadManagementActor = getContext().actorOf(
				FromConfig.getInstance().props(Props.create(BulkUploadManagementActor.class)), BULK_UPLOAD_MGMT_ACTOR);
		...
		courseMetricsRouter = getContext()
				.actorOf(FromConfig.getInstance().props(Props.create(CourseMetricsActor.class)), COURSE_METRICS_ROUTER);
		esSyncActor = getContext().actorOf(FromConfig.getInstance().props(Props.create(EsSyncActor.class)),
				ES_SYNC_ROUTER);
		fileUploadServiceActor = getContext()
		...
		userDataEncryptionDecryptionServiceActor = getContext().actorOf(
				FromConfig.getInstance().props(Props.create(UserDataEncryptionDecryptionServiceActor.class)),
		...
		skillManagementActor = getContext().actorOf(
				FromConfig.getInstance().props(Props.create(SkillmanagementActor.class)), SKILL_MANAGEMENT_ACTOR);
		...
		clientManagementActor = getContext().actorOf(
				FromConfig.getInstance().props(Props.create(ClientManagementActor.class)), CLIENT_MANAGEMENT_ACTOR);
		...
		keyCloakSyncActor = getContext().actorOf(FromConfig.getInstance().props(Props.create(KeyCloakSyncActor.class)),
				KEYCLOAK_SYNC_ACTOR);
