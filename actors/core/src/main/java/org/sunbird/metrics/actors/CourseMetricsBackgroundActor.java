...
public class CourseMetricsBackgroundActor extends BaseMetricsActor {
	...
	public void onReceive(Request request) throws Throwable {
		if (request.getOperation().equalsIgnoreCase(ActorOperations.COURSE_PROGRESS_METRICS_DATA.getValue())) {
	...
	public void courseProgressMetricsData(Request actorMessage) {
		...
		if (!(userCoursesContent.isEmpty())) {
			...
			List<Object> columnNames = Arrays.asList(JsonKey.LOGIN_ID, JsonKey.NAME, JsonKey.CREATED_DATE,
					JsonKey.LANGUAGE, JsonKey.SUBJECT, JsonKey.GRADE, JsonKey.PROGRESS);
