...
public class SystemSettingsActor extends BaseActor {
  ...
  public void onReceive(Request request) throws Throwable {
    ...
    if (request
        .getOperation()
        .equalsIgnoreCase(ActorOperations.GET_SYSTEM_SETTING_BY_ID.getValue())) {
      ...
      getAllSystemSettings();
        ...
        .getOperation()
        .equalsIgnoreCase(ActorOperations.UPDATE_SYSTEM_SETTING_BY_ID.getValue())) {
  ...
  /**
   * This Actor method updates or insert the provided system setting data in the request
   *
   * @param actorMessage instance of Request class contains the request data like id,field,value
   */
  @SuppressWarnings("unchecked")
  ...
  /**
   * This method writes the system setting to system settings table
   *
   * @param systemSetting instance of SystemSetting class with id,field,value
   */
