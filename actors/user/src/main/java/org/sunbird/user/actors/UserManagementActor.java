...
public class UserManagementActor extends BaseActor {
    ...
    public static void init() {
        RequestRouter.registerActor(UserManagementActor.class, Arrays.asList(
                ActorOperations.CREATE_USER.getValue(), ActorOperations.UPDATE_USER.getValue(),
                ...
                ActorOperations.GET_ROLES.getValue(),
                ActorOperations.GET_USER_DETAILS_BY_LOGINID.getValue(),
                ActorOperations.DOWNLOAD_USERS.getValue(),
                ActorOperations.FORGOT_PASSWORD.getValue(),
                ActorOperations.PROFILE_VISIBILITY.getValue(),
                ActorOperations.UNBLOCK_USER.getValue(), ActorOperations.ASSIGN_ROLES.getValue(),
